...
describe("authActions", () => {
  ...
  describe("Login", () => {
    it("should call login api and dispatch setLoginSuccess", async () => {
        ...
        const expectedAction = createExpectedAction(AuthActionType.LOGIN_USER, mockUserResponse)
  ...
  describe("Logout", () => {
      it("should create LOGOUT_USER action", () => {
        const expectedAction = createExpectedAction(AuthActionType.LOGOUT_USER, mockUserResponse)
  ...
  describe("Register", () => {
    it("should call register api and dispatch setRegisterSuccess", async () => {
        ...
        const expectedAction = createExpectedAction(AuthActionType.REGISTER_USER, {message: mockRegisterResponse.message})
      ...
      it("should create REGISTER_USER action", () => {
        const expectedAction = createExpectedAction(AuthActionType.REGISTER_USER, mockUserResponse)
