...
const PublicGamesList: React.FC<Props> = ({ userGames, getPublicGamesListForUser }) => {
            ...
            <Container>
                ...
                {isLoading ? (
                    ...
                    <>
                        ...
                        {gamesPlaying.length ? <PublicGamesListItem title="Playing" games={gamesPlaying} /> : ''}
                        {gamesWishlist.length ? <PublicGamesListItem title="Wishlist" games={gamesWishlist} /> : ''}
                        {gamesOnHold.length ? <PublicGamesListItem title="On Hold" games={gamesOnHold} /> : ''}
                        {gamesFinished.length ? <PublicGamesListItem title="Finished" games={gamesFinished} /> : ''}
                    </>
                )}
            </Container>
        </>
